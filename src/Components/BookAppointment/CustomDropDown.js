const CustomDropDown = ({ onChange, required, options, label, placeHolder, min = "0", type = "text", value, valueName }) => {
  return (
    <div style={{ width: "40%", margin: "15px 5px", display: "inline-block" }}>
